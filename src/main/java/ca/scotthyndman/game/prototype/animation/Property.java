...
/**
 * The Property class is the base class for animating values. Properties have a value, a behavior to control how the
...
public abstract class Property<T> {
	 ...
	 * 
	 * @return all of this Property's {@link PropertyListener}s or an empty array if no listeners are registered.
	 */
	...
	/**
	 * Adds the specified listener to receive events from this Property. If the listener is {@code null}, no exception
	...
	/**
	 * Removes the specified listener so that it no longer receives events from this Property. This method performs no
	 * function, nor does it throw an exception, if the listener specified by the argument was not previously added to
	 * this Property. If the listener is {@code null}, no exception is thrown and no action is performed.
	 * 
	 * @param listener
	...
	/**
	 * Updates this Property, possibly modifying its value if it has a {@link PropertyBehavior}. This method should be
