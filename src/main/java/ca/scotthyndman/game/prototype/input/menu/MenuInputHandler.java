package ca.scotthyndman.game.prototype.input.menu;
...
public class MenuInputHandler extends InputHandler {
	...
	public MenuInputHandler(Display disp) {
		this.disp = disp;
	...
	private class MouseListener implements MouseInputListener {
		...
		/**
		 * Helper method that maps the mouse button to the equivalent FengGUI MouseButton enumeration.
		 * 
		 * @param button
