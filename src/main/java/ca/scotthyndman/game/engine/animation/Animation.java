 ...
 * over time with its {@link #updateAnimation(int)} method, which is typically called by a {@link Timeline} or, in the
 * case of a {@link Tween}, by the {@link Editable} it is attached to.
 * <p>
 ...
 */
public abstract class Animation implements Finishable {
	 ...
	 * @throws IllegalArgumentException
	 *             if duration is 0 and loopDelay is 0.
	 */
	...
	/**
	 * Sets the number of loops to play. A value of {@link #LOOP_FOREVER} causes this timeline to play indefinitely.
	 * <p>
	 * If looping (numLoops != 1), and the duration is 0, this call is ignored.
	 * 
	 * @param numLoops
	 *            The number of times to loop the duration. A value of 1 means the duration is played exactly once.
	 * @throws IllegalArgumentException
	 ...
	 *             if loopDelay is negative.
	 * @throws IllegalArgumentException
	 *             if looping (numLoops != 1), duration is 0, and loopDelay is 0.
	 */
	...
	public boolean updateAnimation(int elapsedTime) {
		return updateAnimation(elapsedTime, false);
	}

	/* package private */boolean updateAnimation(int elapsedTime, boolean parentLooped) {
