...
import ca.scotthyndman.game.engine.animation.event.TimelineEvent;
...
public final class Timeline extends Animation implements Updatable {
	...
	private ArrayList<Property> propertyList; // Editable if PropertyBehavior; false otherwise
	...
	/**
	 * @deprecated Replaced by {@link #add(Editable, Animation) }
	 */
