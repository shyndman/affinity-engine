package ca.scotthyndman.game.engine.animation.event;

import ca.scotthyndman.game.engine.animation.Animation;

/**
 * A TimelineEvent is an abstract class that can perform a certain action after a specific delay. TimelineEvents are
 * added to and executed by a {@link ca.scotthyndman.game.engine.animation.Timeline}. Subclasses implement the
 * {@link #run } method.
 * <p>
