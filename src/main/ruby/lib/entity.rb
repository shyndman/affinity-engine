...
class Entity
  ...
  #
  # Gets the State object with the specified name, or nil of none exists. This method will 
  # search superclasses if the state isn't found defined on this class. A class from which
  # to to start the search from can optionally be provided.
  #
  def get_state state_name, cls = self.class
    cls.get_state state_name
  end
  ...
  #
  # Performs necessary decoration on all classes that subclass this one. This method
  # is triggered when a this class is inherited from.
  #
...
if __FILE__ == $0
  ...
  class A < Entity  
    ...
    initial state :begin do
      puts "superclass begin state entered"
      sleep 1
    end
